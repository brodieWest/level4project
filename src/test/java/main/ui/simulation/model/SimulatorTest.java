...
public class SimulatorTest extends ApplicationTest {
    ...
    public void calculatePathDepthOneComponent() {
        ...
        mainSimulationController.setSimulationMode(SimulationMode.SIMULATE);
        mainSimulationController.resetSimulation();
        mainSimulationController.wireDelay();
        mainSimulationController.calculatePathDepth();


        //simulator.calculatePathDepth(outputs, mainSimulationController);

        assertEquals(1,mainSimulationController.getPathDepth());
    }
